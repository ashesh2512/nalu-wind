...
#ifndef MOMENTUMEDGESOLVERALGCUBE_H
#define MOMENTUMEDGESOLVERALGCUBE_H
...
class MomentumEdgeSolverAlgCube : public AssembleEdgeSolverAlgorithm
{
public:
  MomentumEdgeSolverAlgCube(
    Realm&,
    stk::mesh::Part*,
    EquationSystem*);

  virtual ~MomentumEdgeSolverAlgCube() = default;
